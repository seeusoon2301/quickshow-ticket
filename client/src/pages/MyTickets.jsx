      ...
      if (response.ok && data.success) {
        ...
        const transformedTickets = data.data.tickets.map(ticket => ({
          ...
          event: {
            ...
            time: ticket.concert?.start_time ? new Date(ticket.concert.start_time).toLocaleTimeString("vi-VN", { hour: "2-digit", minute: "2-digit" }) : "",
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-primary">
                            {ticket.ticketClass.price.toLocaleString()}đ
                          </p>
                        </div>
