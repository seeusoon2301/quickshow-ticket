...
const OrganizerSection = ({ organizer }) => {
  ...
  const description = organizer.organizer?.description || "Nhà tổ chức sự kiện chuyên nghiệp";
  ...
  return (
    <section id="section-organizer" className="px-6 md:px-16 lg:px-24 py-10 border-t border-white/10">
      <h2 className="text-2xl font-bold text-white mb-6">Ban tổ chức</h2>
        ...
        {organizer.organizer?.verified && (
          <div className="mt-4 pt-4 border-t border-white/10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-blue-400 text-sm font-medium">Đã xác minh</span>
            </div>
          </div>
        )}
      </div>
